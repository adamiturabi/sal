...
4. I'm also planning to automatically display the text of referenced definitions, or at least hyperlink them, so that the reader does not have to retype another search term. I think some XML editing may be required for this.
